...
def get_game_stats_and_update_spread(date_string: str, week_index: int, tournament: str, team1: str = None,
    ...
    if player_response is not None:
        ...
        for game_dict_key in player_data:
            ...
            score_to_update.append(temp_player_points)
...
def update_spreadsheet_player_points(scores_to_update: [], league: str, week_index: int,
    ...
    # TODO    if yes: creata local playerpoints object, adjust values with new ones, update database with playerpointsID
